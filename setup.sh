...
sudo apt-get -yy install gstreamer1.0-plugins-{base,good,bad,ugly} gstreamer1.0-libav libc6:i386 libncurses5:i386 libstdc++6:i386 lib32z1 libbz2-1.0:i386		## Getting a youtube videos to work without flash
